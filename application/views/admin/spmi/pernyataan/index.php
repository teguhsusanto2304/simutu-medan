    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <?php 
                    $contentHeaderOptions   =   ['pageName' => 'Pernyataan'];
...
<script language='Javascript'>
    ...
    let _dataTableOptions   =  {
        ...
        columns     :   [
            ...
            {data : null, render : function(data, type, row, metaData){
                let _idPernyataan          =   data.pernyataanId;
                ...
                return `<div class='text-center'>
                            ...
                            <span class='fa fa-trash text-danger cp' data-toggle='tooltip' data-placement='top'
                                title='Hapus Data Pernyataan ${_namaPernyataanUC}' onClick='hapusPernyataan(this, "${_idPernyataan}", "${_namaPernyataanUC}")'></span>
                        </div>`;
            }}
        ]
    };
    ...
    async function hapusPernyataan(thisContext, _idPernyataan, judulStandart) {
        let _el                 =   $(thisContext);

        let _title          =   'Konfirmasi Hapus';
        let _htmlMessage    =   `Apakah anda yakin akan menghapus Pernyataan <b class='text-primary'>${judulStandart}</b> ?`;
        ...
        if(_confirm){
            $.ajax({
                ...
                success :   (decodedRFS) => {
                    ...
                    let _title  =   'Pernyataan';
                    let _icon, _message, _onClick;
                    if(_statusHapus){
                        _icon       =   'success';
                        _message    =   `<span class='text-success'>Berhasil menghapus Pernyataan!</span>`;   
                        _onClick    =   function(){
