<?php
	class MasterPenilaianModel extends CI_Model{
        ...
        public function savePenilaian($idPenilaian = null, $dataPenilaian = null){
            $tabelPenilaian    =   $this->tabel->penilaian;
                
            if(is_null($dataPenilaian)){
                extract($_POST);
            ...
            if(is_null($idPenilaian)){
                $savePenilaian  =   $this->db->insert($tabelPenilaian, $dataPenilaian);
                $idPenilaian    =   $this->db->insert_id();

                $isUpdate   =   false;
            }else{
                $this->db->where('idPenilaian', $idPenilaian);
                $savePenilaian  =   $this->db->update($tabelPenilaian, $dataPenilaian);
                $isUpdate   =   true;
            }
        ...
        public function deletePenilaian($idPenilaian = null){
            ...
            if(!is_null($idPenilaian)){
                ...
                $detailPenilaian =   $this->getPenilaian($idPenilaian, $options);

                if($detailPenilaian !== false){
                    $idPenilaian    =   $detailPenilaian['idPenilaian'];

                    $this->load->model('PenetapanDetailModel', 'penetapandetailspmi');
                    ...
                    $penetapandetailspmi    =   $this->penetapandetailspmi->getPenetapanDetail(null, $options);

                    if(count($penetapandetailspmi) <= 0){
                        $this->db->where('idPenilaian', $idPenilaian);
                    ...
                    $messageDelete  =   'Data Penilaian tidak ditemukan!';
                }
            }else{
                $messageDelete  =   'ID Penilaian tidak ada!';
            }
